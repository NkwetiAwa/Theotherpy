...
import { Image, ActivityIndicator, TouchableOpacity, Text, StyleSheet, View, TextInput, Alert} from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={{ marginTop: '-20%', width: '94%', padding: 10, paddingBottom: 20, borderRadius: 8, borderTopLeftRadius: 15, borderTopRightRadius: 15, backgroundColor: 'white', elevation: 5 }}>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('DocSignUp')} style={{ alignItems: 'center', marginTop: 15 }}>
